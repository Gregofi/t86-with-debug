...
public:
    ...
    /**
     * Returns optional element of either same or lesser id (using comp
     * function)
     */
...
private:
    ...
    // It is sorting from largest to smallest to find writes with equal or
    // lesser id using std::lower_bound

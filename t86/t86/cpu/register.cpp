...
RegisterOffsetRegisterScaled RegisterOffset::operator+(
...
RegisterOffsetRegisterScaled RegisterOffset::operator-(
    RegisterScaled regScaled) const {
    return RegisterOffsetRegisterScaled(
        *this, regScaled.reg() * -regScaled.scale());
}
...
RegisterOffsetRegisterScaled RegisterScaled::operator+(
...
RegisterOffsetRegisterScaled RegisterOffsetRegister::operator*(
    int64_t scale) const {
    return RegisterOffsetRegisterScaled(regOffset_, reg_ * scale);
}

RegisterOffsetRegisterScaled RegisterRegisterScaled::operator+(
...
RegisterOffsetRegisterScaled RegisterScaledOffset::operator+(
    Register reg) const {

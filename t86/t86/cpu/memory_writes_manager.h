...
public:
    MemoryWrite::Id currentMaxWriteId() const { return currentId; }
    ...
    /// Specify value of the write, this does not transitions the write to
    /// outgoing state
     ...
     */
    std::optional<MemoryWrite> previousWrite(

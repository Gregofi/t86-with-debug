 ...
 * For example this would arise if you called ADD PC 5 - PC should not be
 * modified by "non-jump" instruction
 */
class Instruction::InvalidOperand : public std::runtime_error {
public:
    InvalidOperand(Register reg)
        : std::runtime_error("Invalid use of register " + reg.toString()) { }
};

class BinaryArithmeticInstruction : public Instruction {
public:
    BinaryArithmeticInstruction(
        std::function<Alu::Result(int64_t, int64_t)> op, Register reg,
        Register val)
        : op_(std::move(op))
        , dest_(reg)
        , reg_(reg)
    ...
    BinaryArithmeticInstruction(
        std::function<Alu::Result(int64_t, int64_t)> op, Register dest,
    ...
    bool needsAlu() const override { return true; }
    ...
    std::vector<Operand> operands() const override { return { reg_, val_ }; }
...
public:
    FloatBinaryArithmeticInstruction(
        std::function<Alu::FloatResult(double, double)> op, FloatRegister fReg,
        FloatRegister val)
        : op_(std::move(op))
        , fReg_(fReg)
        , val_(val) { }
    ...
    std::vector<Operand> operands() const override { return { fReg_, val_ }; }
...
public:
    UnaryArithmeticInstruction(
        std::function<Alu::Result(int64_t)> op, Register reg)
        : op_(std::move(op))
        , reg_(reg) { }
    ...
    std::vector<Operand> operands() const override { return { reg_ }; }
...
public:
    bool needsAlu() const override { return false; }
};
...
public:
    ...
    std::vector<Operand> operands() const override { return {}; }

    std::vector<Product> produces() const override { return {}; }
};
...
public:
    MOV(Register destination, int64_t value)
        : destination_(destination)
        , value_(value) { }

    MOV(Register destination, Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Register destination, Memory::Immediate value)
        : destination_(destination)
        , value_(value) { }

    MOV(Register destination, Memory::Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Register destination, Memory::RegisterOffset value)
        : destination_(destination)
        , value_(value) { }

    MOV(Register destination, Memory::RegisterScaled value)
        : destination_(destination)
        , value_(value) { }

    MOV(Register destination, Memory::RegisterRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Register destination, Memory::RegisterOffsetRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Register destination, Memory::RegisterRegisterScaled value)
        : destination_(destination)
        , value_(value) { }

    MOV(Register destination, Memory::RegisterOffsetRegisterScaled value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::Immediate destination, int64_t value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::Immediate destination, Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::Register destination, int64_t value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::Register destination, Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterOffset destination, int64_t value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterOffset destination, Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterScaled destination, int64_t value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterScaled destination, Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterRegister destination, int64_t value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterRegister destination, Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterOffsetRegister destination, int64_t value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterOffsetRegister destination, Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterRegisterScaled destination, int64_t value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterRegisterScaled destination, Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterOffsetRegisterScaled destination, int64_t value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterOffsetRegisterScaled destination, Register value)
        : destination_(destination)
        , value_(value) { }

    // FLOAT

    MOV(Register destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(FloatRegister destination, double value)
        : destination_(destination)
        , value_(value) { }

    MOV(FloatRegister destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(FloatRegister destination, Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(FloatRegister destination, Memory::Immediate value)
        : destination_(destination)
        , value_(value) { }

    MOV(FloatRegister destination, Memory::Register value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::Immediate destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::Register destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterOffset destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterScaled destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterRegister destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterRegisterScaled destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterOffsetRegister destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Memory::RegisterOffsetRegisterScaled destination, FloatRegister value)
        : destination_(destination)
        , value_(value) { }

    MOV(Operand destination, Operand value)
...
public:
    ...
    std::vector<Operand> operands() const override { return { reg_, value_ }; }
...
public:
    FCMP(FloatRegister fReg, double value)
        : fReg_(fReg)
        , value_(value) { }

    FCMP(FloatRegister fReg, FloatRegister value)
        : fReg_(fReg)
        , value_(value) { }

    FCMP(FloatRegister fReg, Operand value)
        : fReg_(fReg)
        , value_(value) { }
...
public:
    PatchableJumpInstruction(uint64_t address)
        : address_(static_cast<int64_t>(address)) { }

    PatchableJumpInstruction(Register address)
        : address_(address) { }

    PatchableJumpInstruction(Memory::Immediate address)
        : address_(address) { }

    PatchableJumpInstruction(Memory::Register address)
        : address_(address) { }

    PatchableJumpInstruction(Memory::RegisterOffset address)
        : address_(address) { }

    PatchableJumpInstruction(Operand address)
        : address_(address) { }

    void setDestination(uint64_t address);

    Operand getDestination() const override { return address_; }
...
public:
    ConditionalJumpInstruction(
        std::function<bool(Alu::Flags)> condition, uint64_t address)
        : PatchableJumpInstruction { address }
        , condition_ { std::move(condition) } { }

    ConditionalJumpInstruction(
        std::function<bool(Alu::Flags)> condition, Register address)
        : PatchableJumpInstruction { address }
        , condition_ { std::move(condition) } { }

    ConditionalJumpInstruction(
        std::function<bool(Alu::Flags)> condition, Memory::Immediate address)
        : PatchableJumpInstruction { address }
        , condition_ { std::move(condition) } { }

    ConditionalJumpInstruction(
        std::function<bool(Alu::Flags)> condition, Memory::Register address)
        : PatchableJumpInstruction { address }
        , condition_ { std::move(condition) } { }

    ConditionalJumpInstruction(std::function<bool(Alu::Flags)> condition,
        Memory::RegisterOffset address)
        : PatchableJumpInstruction { address }
        , condition_ { std::move(condition) } { }

    ConditionalJumpInstruction(
        std::function<bool(Alu::Flags)> condition, Operand address)
        : PatchableJumpInstruction { address }
        , condition_ { std::move(condition) } { }
...
public:
    JMP(Register address)
        : PatchableJumpInstruction(address) { }

    JMP(uint64_t address)
        : PatchableJumpInstruction(address) { }

    JMP(Operand operand)
        : PatchableJumpInstruction(operand) { }

    Type type() const override { return Type::JMP; }

    std::size_t length() const override;

    std::vector<Operand> operands() const override { return { address_ }; }
...
public:
    ...
    std::vector<Operand> operands() const override {
        return { address_, Register::ProgramCounter(),
            Register::StackPointer() };
    }
    ...
    std::vector<Product> produces() const override {
        return { Register::ProgramCounter(), Register::StackPointer(),
...
public:
    ...
    std::vector<Operand> signatureOperands() const override { return {}; }
...
public:
    ...
    std::vector<Product> produces() const override { return { reg_ }; }
...
public:
    PUTCHAR(Register reg, std::ostream& os = std::cout)
        : reg_(reg)
        , os_(os) { }
...
public:
    PUTNUM(Register reg, std::ostream& os = std::cout)
        : reg_(reg)
        , os_(os) { }
...
public:
    GETCHAR(Register reg, std::istream& is = std::cin)
        : reg_(reg)
        , is_(is) { }
...
public:
    EXT(FloatRegister fReg, Register reg)
        : fReg_(fReg)
        , reg_(reg) { }
    ...
    std::vector<Product> produces() const override { return { fReg_ }; }
...
public:
    NRW(Register reg, FloatRegister fReg)
        : reg_(reg)
        , fReg_(fReg) { }
    ...
    std::vector<Operand> operands() const override { return { fReg_ }; }

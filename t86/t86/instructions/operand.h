 ...
 * Some instructions don't allow all of there operands by having specific
 * constructors
 */
class Operand {
public:
    ...
    getRegisterOffsetRegisterScaled() const;
    ...
    getMemoryRegisterOffsetRegister() const;

    const Memory::RegisterRegisterScaled&
    getMemoryRegisterRegisterScaled() const;

    const Memory::RegisterOffsetRegisterScaled&
    getMemoryRegisterOffsetRegisterScaled() const;
    ...
    static Memory::Immediate supply(
        const Memory::RegisterOffset& mem, int64_t val);

    static Memory::RegisterOffset supply(
...
private:
    std::variant<int64_t, double, Register, FloatRegister, RegisterOffset,
        RegisterRegister, RegisterScaled, RegisterOffsetRegister,
        RegisterRegisterScaled, RegisterOffsetRegisterScaled,
        Memory::Immediate, Memory::Register, Memory::RegisterOffset,
        Memory::RegisterRegister, Memory::RegisterScaled,
        Memory::RegisterOffsetRegister, Memory::RegisterRegisterScaled,
        Memory::RegisterOffsetRegisterScaled>
        value_;
};
} // namespace tiny::t86

...
public:
    FloatRegisterRead(FloatRegister fReg)
        : fReg_(fReg) { }

    FloatRegister fReg() const { return fReg_; }
...
class Requirement {
public:
    Requirement(RegisterRead regRead)
        : value_(regRead) { }

    Requirement(FloatRegisterRead fRegRead)
        : value_(fRegRead) { }

    Requirement(MemoryRead memRead)
        : value_(memRead) { }
